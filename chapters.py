...
def chapter_1():
    ...
    while True:
        ...
        if choice_player == "1": #Primer final
            s.pass_line()
            s.dialogue("Edgar", "Bueno, el revólver ya esta Listo. Zhora solo toca jugar.")
...
def chapter_3():
    s.dialogue("Gonzalez", "Teniente esos bandolos debieron de llegar de algun pueblo o asentamiento.")
    ...
    s.dialogue("Extraño", "¡Eh, alto ahi o disparo!")
    ...
    s.dialogue("Gonzalez", "Deberíamos quedarmos esta noche y luego partir.")
...
def chapter_4():
    ...
    s.dialogue("Fernandez", "El grupo que llegue a salvo deberá de emprender una busqueda.")
    ...
    s.question("Deberíamos separarnos en grupos de dos.",
                ...
                "Deberíamos manternos todos juntos.")
    ...
    while True:
        ...
        if choice_player == "1":
            ...
            s.dialogue("Rodriguez", "Pero, teniente...")
            s.ending("final_malo")
            s.ascci_end("B", "Solo llego un soldado que murió de depresión poco después.")
            ...
            s.ascci_end("S", "Todo el batallón volvio a Santiago, ahora están junto a su patria y familia.")
